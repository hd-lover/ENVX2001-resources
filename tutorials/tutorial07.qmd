...
For Multiple linear regression we are testing two (or more) predictors, so we have multiple null and alternative hypotheses to test. We 

$H_0: \beta_1 = \beta_2 = 0$ (there is no relationship between diameter, height and volume)

$H_1: \beta_1 \neq 0$ and/or $\beta_2 \neq 0$ (there is a relationship between diameter, height and volume)
