...
**not writing a report this week??? just the results!!!**
...
*(iii)* Check the assumptions of your model. Do you need to transform any variables? Do you notice any other issues?
...
We can compare the models using the adjusted r^2^, but we will need to use hypothesis testing  to decide whether the reduced model is a significant improvement or not. To do this, we can use the F-test to compare the full and reduced models.
