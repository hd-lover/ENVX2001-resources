...
$$
\textrm{relative\_fitness} = \beta_0 + \beta_1\cdot \textrm{growth\_rate} + \beta_2\cdot \textrm{days\_to\_flower} + \beta_3\cdot \textrm{specific\_leaf\_area} + \beta_4\cdot \textrm{root\_shoot\_ratio} +  \beta_5\cdot \textrm{chlorogenic\_acid} + \epsilon_{i}
$$
